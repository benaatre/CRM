...
// «الحزمة ب»: مع السحب **التلقائي** (autoSweepEnabled) تسقط حجة «الاقتراح لا التنفيذ»،
// فتُفرض أرضية أمان دنيا للمهلة — أقل من ساعة يسحب عملاء من موظفين اتصلوا ولم يسجّلوا بعد.
// مسار الاقتراح اليدوي يبقى بلا أرضية كما هو.
export const MIN_AUTO_SWEEP_TIMEOUT_MIN = 60;
