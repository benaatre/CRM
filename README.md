...
> **الحالة:** المرحلة (١) — التهيئة والأساس مكتملة. خارطة المراحل في [`sultan-crm-nextjs-spec.md`](./sultan-crm-nextjs-spec.md). دليل العمل في [`CLAUDE.md`](./CLAUDE.md).
...
| `ANTHROPIC_API_KEY` | مفتاح المساعد الذكي (خادم فقط) |
